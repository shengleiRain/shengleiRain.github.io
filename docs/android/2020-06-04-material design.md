...
- **自然的**：应该考虑物体的上升、下降、摩擦力等物理因素。
  ...
  ![16dx20160512](../assets/images/20200606/16dx20160512.png#pic_center)

- **可察觉的**：一个物体的运动，应该要被周围的物体所察觉。具有联动的动画效果，过渡的元素和周围物体的运动也需要精心的安排。例如

  ![13dx20160512](../assets/images/20200606/13dx20160512.png#pic_center)

  ![12dx20160512](../assets/images/20200606/12dx20160512.png#pic_center)

- **有引导意义的**：转场动画有助于引导下一步交互。

  ![9dx20160512](../assets/images/20200606/9dx20160512.png#pic_center)
...
![basic color](../assets/images/20200606/basic_color.png#pic_center)

<center>Basic Color</center>

#### Primary color

是App组件和屏幕上使用最多的颜色，体现的是应用的主题颜色。包括dark和light两个变体颜色。

![primary color](../assets/images/20200606/color.png#pic_center)
...
![secondary](../assets/images/20200606/secondary.png#pic_center)
...
![other colors](../assets/images/20200606/other%20color.png#pic_center)

#### On Color

材料背景上的文字或者图标的颜色。

![on color](../assets/images/20200606/On%20Color.png#pic_center)
...
![material components](../assets/images/20200606/uisdc-materialdesign-20170919-1.png#pic_center)
